					...
					<div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
						<div class="truncate">
							<div class="flex text-sm">
								<p class="font-medium text-indigo-600 truncate">Machinery maintenance</p>
			...
			<a href="#" class="block hover:bg-gray-50">
				<div class="px-4 py-4 flex items-center sm:px-6">
					<div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
						<div class="truncate">
							<div class="flex text-sm">
								<p class="font-medium text-indigo-600 truncate">Mechanical and Civil Engineer</p>
								<p class="ml-1 flex-shrink-0 font-normal text-gray-500">in Engineering</p>
							</div>
							<div class="mt-2 flex">
								<div class="flex items-center text-sm text-gray-500">
			...
			<a href="#" class="block hover:bg-gray-50">
				<div class="px-4 py-4 flex items-center sm:px-6">
					<div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
						<div class="truncate">
							<div class="flex text-sm">
								<p class="font-medium text-indigo-600 truncate">Hotel Interior Design</p>
							...
							<div class="mt-2 flex">
								<div class="flex items-center text-sm text-gray-500">
									<!-- Heroicon name: solid/calendar -->
									<i class="fa-solid fa-dollar-sign fa-lg flex-shrink-0 mr-1.5 h-5 w-5" />
									<p>
										Current bid: <span class="font-medium text-gray-500">$1,500</span>
									</p>
								</div>
							</div>
						</div>
