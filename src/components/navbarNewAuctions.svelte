...
>
	<a
		href="/auctions/new"
		class:active={$current === '/auctions/new'}
		on:click={() => handleClick('/auctions/new')}
	...
	>
		<i class="fa-solid fa-plus fa-lg  text-gray-600" /><span
			class="flex-1 ml-3 whitespace-nowrap  text-gray-600">New auction</span
		>
	</a>
</li>
